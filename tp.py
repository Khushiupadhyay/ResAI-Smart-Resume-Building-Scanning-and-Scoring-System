...
def generate_resume():
    ...
    resume_data = conversations[session_id]['data']
...
def process_message(message, conversation):
    ...
    if state == 'greeting':
        ...
        return "Welcome to the Resume Builder Chatbot! Let's create your professional resume together. First, please tell me your full name."
        ...
        if message.lower() in TEMPLATES.keys():
            ...
            return "Your resume information is complete! You can now generate your PDF resume by clicking the 'Generate Resume' button. We'll use AI to enhance your descriptions and create a polished resume!"
        else:
        ...
        return "Your resume information is already complete. You can generate your PDF resume by clicking the 'Generate Resume' button, or start over with a new resume."
...
def enhance_resume_content_api():
